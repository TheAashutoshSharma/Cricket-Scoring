    ...
    return (
      <div style={{...S.card,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
		...
		<button onClick={undo} disabled={!history.length}
			  style={{width:"25%",padding:"1px 0",borderRadius:10,border:"1px solid rgba(14,116,144,.4)",
                  opacity:history.length?1:0.3,color:"#fb923c",borderColor:history.length?"rgba(251,146,60,.3)":"transparent",fontWeight:"bold",fontSize:5,cursor:"pointer",touchAction:"manipulation",fontFamily:"Lexend,Georgia,sans-serif",
                  letterSpacing:1}}>
              Undo
			  ↩
        </button>
